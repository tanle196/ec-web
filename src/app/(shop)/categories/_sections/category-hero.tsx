      ...
      >
        ...
        <div className="relative grid grid-cols-2 gap-12 items-center px-14 py-16 h-full">
          ...
          <div className="flex flex-col gap-0">
            ...
            <h1
              className="text-[clamp(48px,4.5vw,72px)] font-bold leading-[0.96] tracking-[-0.035em] text-muted mt-5 mb-4"
            >
              {hero.headlineLine1}
              <br />
              <span style={{ color: "var(--color-cta)" }}>{hero.headlineLine2}</span>
            </h1>
            <p
              className="text-[18px] leading-relaxed text-text-tertiary max-w-110 mb-7"
            >
              {hero.subtitle}
            </p>
