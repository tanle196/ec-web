...
type ActivityKind = "delivered" | "pickup" | "hub" | "transit" | "verified" | "confirmed";

const ACTIVITY: { kind: ActivityKind; message: string; date: string }[] = [
  { kind: "delivered",  message: "Your order has been delivered. Thank you for shopping at Clicon!", date: "23 Jan, 2021 at 7:32 PM" },
  { kind: "pickup",    message: "Our delivery man (John Wick) Has picked up your order for delivery.", date: "23 Jan, 2021 at 3:09 PM" },
  { kind: "hub",       message: "Your order has reached at last mile hub.", date: "22 Jan, 2021 at 8:04 AM" },
  { kind: "transit",   message: "Your order is on the way to East mile hub.", date: "21 Jan, 2021 at 12:36 AM" },
  { kind: "verified",  message: "Your order is successfully verified.", date: "20 Jan, 2021 at 7:32 PM" },
  { kind: "confirmed", message: "Your order has been confirmed.", date: "18 Jan, 2021 at 2:47 PM" },
];
...
function ActivityIcon({ kind }: { kind: ActivityKind }) {
  ...
  const bg = isGreen ? "bg-success-50 border-[#d5f0d3]" : "bg-secondary-50 border-secondary-100";
  return (
    <div className={`flex-none p-3 rounded-[2px] border ${bg}`}>
      {kind === "delivered" && (
...
function ProgressDot({ done, active }: { done: boolean; active: boolean }) {
  ...
  return <div className="w-6 h-6 rounded-full border-2 border-gray-100 bg-white flex-none" />;
}
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-[4px]">
              <div className="p-6 flex flex-col gap-6">
                ...
                <div className="bg-[#fdfae7] border border-[#f7e99e] rounded-[4px] px-6 py-5 flex items-center justify-between">
                  <div className="flex flex-col gap-1">
                    <p className="text-[20px] leading-7 font-normal text-gray-900">{orderId}</p>
              ...
              <div className="border-t border-gray-100 p-6 flex flex-col gap-5">
                <p className="text-[18px] font-medium text-gray-900">Order Activity</p>
            ...
            <div className="bg-white border border-gray-100 rounded-[4px]">
              ...
              {PRODUCTS.map((product, i) => (
                ...
                >
                  ...
                  <span className="text-[14px] text-gray-700">x{product.qty}</span>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-gray-100 rounded-[4px] p-6 flex flex-col gap-3">
                ...
                <p className="text-[14px] leading-5 text-gray-700">{ORDER_NOTES}</p>
              </div>
            </div>
          </div>
        </div>
