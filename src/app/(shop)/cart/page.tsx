  ...
  return (
    <div className="flex items-center gap-6">
      ...
      >
        ...
        <p className="text-[14px] leading-5 text-[#191c1f] line-clamp-3 min-w-0">
          {item.name}
        </p>
      </div>
          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="flex-1 min-w-0 border border-[#e4e7e9] rounded-[4px]">
              ...
              <div className="flex items-center gap-6 bg-[#f2f4f5] border-b border-[#e4e7e9] px-6 py-2.5">
                <p
                  className="text-[12px] font-medium text-gray-700 uppercase tracking-wide"
                  style={{ width: 380, flexShrink: 0 }}
                >
                  Products
                </p>
                <p
                  className="text-[12px] font-medium text-gray-700 uppercase tracking-wide flex-none"
                  style={{ width: 88 }}
                >
                  Price
                </p>
