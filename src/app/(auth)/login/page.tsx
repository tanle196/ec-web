      ...
      <div className="bg-[#f2f4f5] h-18 flex items-center">
        <div className="max-w-7xl mx-auto px-16 w-full">
          <nav className="flex items-center gap-2 text-[14px] leading-5">
            ...
            <span className="font-medium text-[#2da5f3]">Sign In</span>
          </nav>
        </div>
      </div>
        ...
        <div className="bg-white border border-[#e4e7e9] rounded-[4px] shadow-[0px_8px_40px_0px_rgba(0,0,0,0.12)] w-106 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 px-8 pt-8 pb-8">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[14px] leading-5 text-[#191c1f]">Email Address</label>
              <input
                type="email"
                required
                autoComplete="email"
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <label className="text-[14px] leading-5 text-[#191c1f]">Password</label>
                <Link href="/forgot-password" className="text-[14px] leading-5 font-medium text-[#2da5f3] no-underline hover:underline">
                  Forget Password
                </Link>
              </div>
