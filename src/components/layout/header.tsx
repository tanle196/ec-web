...
function ClIconLogo() {
  return (
    <Link href="/" className="flex items-center gap-2 flex-none no-underline" aria-label="Clicon home">
      <span className="w-12 h-12 rounded-full bg-white flex items-center justify-center flex-none" aria-hidden>
  ...
  return (
    <header>
              ...
              <div className="flex items-center gap-5 ml-auto">
                ...
                <div className="hidden lg:flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3 text-white/80">
                    ...
                    <a href="#" aria-label="Reddit" className="hover:text-white transition-colors"><RedditIcon /></a>
                ...
                <div className="hidden lg:block h-7 w-px bg-white/30" aria-hidden />

                <button className="flex items-center gap-1.5 text-white text-body-sm hover:text-white/80 transition-colors">
                  Eng <ChevronDown size={12} className="opacity-50" aria-hidden />
                </button>
                <button className="flex items-center gap-1.5 text-white text-body-sm hover:text-white/80 transition-colors">
                  USD <ChevronDown size={12} className="opacity-50" aria-hidden />
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-330 mx-auto px-4 lg:px-8 py-5">
          <div className="flex items-center gap-6 lg:gap-10">
            ...
            >
              ...
              />
              <button type="submit" aria-label="Submit search" className="flex-none text-gray-500 hover:text-gray-700 transition-colors">
                <Search size={20} />
              </button>
            </form>

            <div className="flex items-center gap-5 flex-none">
              <Link href="/cart" className="relative" aria-label="Cart, 2 items">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-330 mx-auto px-4 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden lg:flex items-center gap-6" aria-label="Quick links">
                ...
                <Link href="/compare" className="flex items-center gap-1.5 text-body-sm text-gray-600 no-underline hover:text-gray-900 transition-colors">
                  <ArrowLeftRight size={22} strokeWidth={1.5} aria-hidden /> Compare
                </Link>
                <Link href="/support" className="flex items-center gap-1.5 text-body-sm text-gray-600 no-underline hover:text-gray-900 transition-colors">
                  <Headphones size={22} strokeWidth={1.5} aria-hidden /> Customer Support
                </Link>
                <Link href="/help" className="flex items-center gap-1.5 text-body-sm text-gray-600 no-underline hover:text-gray-900 transition-colors">
            ...
            <address className="hidden lg:flex items-center gap-2 not-italic">
              <Phone size={26} strokeWidth={1.5} className="text-gray-900" aria-hidden />
              <a href="tel:+12025550104" className="text-body-lg text-gray-900 no-underline hover:text-primary transition-colors">
                +1-202-555-0104
              </a>
            </address>
